        ...
        try{
            if(ae.getSource()==b1){
               ...
               // if(atype.equals("")){
                ...
                //}else{
                    Conn c1 = new Conn();
                    //System.out.println(fno+" "+ atype+" "+ cardno+" "+pin+" "+ facility);
                    String q1 = "insert into signupThree values('"+fno+"','"+cardno+"','"+pin+"','"+facility+"','"+atype+"')";  
                    String q2 = "insert into login values('"+fno+"','"+cardno+"','"+pin+"')";
